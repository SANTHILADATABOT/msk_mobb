	...
	<div class="table-responsive">               
	  <table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100 new-table">
		...
		<tbody>						
			...
			$admission_card = $pdo_conn->prepare("SELECT * FROM admission_card WHERE delete_status!='1' and user_id='$user_id'");
...
function admission_card_create(country_id,state_id,district_id,city_id,area_id,user_id,unique_no,completed_status)
{
	...
	$('#page_replace_div').load(FILE_PATH + '/admission_card/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
{
	$("#previous_id").val('admission_card/create.php');
	$('#page_replace_div').load(FILE_PATH + '/admission_card/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&admission_card_id='+admission_card_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
