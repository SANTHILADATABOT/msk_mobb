...
if($_POST['action']=='ADD')
{
	$pdo_statement = $pdo_conn->prepare("INSERT INTO admission_card (entry_date,patient_name, token_id, id_number, address, mobile_no, hospital_name, contact_person, phone_number, landmark, country_id, state_id, district_id, area_id ,user_id,city_id) VALUES (:entry_date,:patient_name,:token_id,:id_number,:address,:mobile_no,:hospital_name,:contact_person,:phone_number,:landmark,:country_id, :state_id, :district_id, :area_id,:user_id,:city_id)");
			
	$pdo_array=array(':entry_date'=>$current_date,':patient_name'=>$_POST['patient_name'],':token_id'=>$_POST['token_id'],':id_number'=>$_POST['id_number'],':address'=>$_POST['address'],':mobile_no'=>$_POST['mobile_no'],':hospital_name'=>$_POST['hospital_name'],':contact_person'=>$_POST['contact_person'],':phone_number'=>$_POST['phone_number'],':landmark'=>$_POST['landmark'],':country_id'=>$_POST['country_id'],':state_id'=>$_POST['state_id'],':district_id'=>$_POST['district_id'],':area_id'=>$_POST['area_id'],':user_id'=>$_POST['user_id'],':city_id'=>$_POST['city_id']);
