...
<table border="1">
	...
	<tbody id="areawise_count_list">
		<?php
		$survey = $pdo_conn->prepare("SELECT survey_id,user_id,country_id,state_id,district_id,city_id,area_id,contact_no,unique_no,completed_status FROM fact_finding_form WHERE delete_status!='1' and user_id='$user_id' $query ORDER BY survey_id DESC");
		$survey->execute();
