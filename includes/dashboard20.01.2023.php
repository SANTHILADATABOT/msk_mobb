  ...
  <div class="container h-100 animated bounceInLeft"
    style="background-image: url('img/login_bg1.jpg'); background-size: cover;">
      ...
      <div class="align-self-center mx-auto">
        <div class="voln_img1 btn btn-light btn-square-md"> <img src="<?php echo $image_path;?>/vo.png" style="width:100px;height:100px">
    ...
    <div class="col-6 rounded-lg">
      <div class="align-self-center mx-auto">
        <div class="voln_img1 btn btn-light btn-square-md"> <img src="<?php echo $image_path;?>/sur.png" style="width:100px;height:100px">
...
function get_volunteer_form() 
{
    ...
    $('#page_replace_div').load(FILE_PATH + '/volunteer_form.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
function get_survey_form() 
{
    ...
    var city_id = $("#city_id").val();
    var area_id = $("#area_id").val();
    var uni_no = $("#uni_no").val();
    var unique_no = '<?php echo $unique_no ?>';
    var completed_status='<?php echo $completed_status ?>';
    $("#previous_id").val('survey1.php');
    $('#page_replace_div').load(FILE_PATH + '/survey1.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
function get_food_needed() 
{
    ...
    $('#page_replace_div').load(FILE_PATH + '/food_details_form/list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
function get_survey_list()
{
    ...
    var area_id = $("#area_id").val();
  $("#previous_id").val('medical_help/list.php');
  $('#page_replace_div').load(FILE_PATH + '/survey_report/list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
function get_admission_card()
{
  ...
  $('#page_replace_div').load(FILE_PATH + '/admission_card/list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no);
}
