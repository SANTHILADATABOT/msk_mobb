...
function get_survey_area() 
{
  ...
  $('#page_replace_div').load(FILE_PATH + '/dashboard.php?user_id='+user_id+'&user_type='+user_type+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no);
}
