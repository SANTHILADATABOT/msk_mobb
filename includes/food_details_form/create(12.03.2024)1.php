                ...
                <div class="col-md-12 survey_content">
                    <form class="login_form">
                        ...
                        <div class="form-group">
                            <label for=""><span class="notranslate">Masjidh Service Committee Name</span><span
                                    style="color:red;">*</span></label>
                            <input type="text" class="form-control" id="organization_name" name="organization_name"
                                value="<?php echo $record['organization_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="s_no" name="s_no"
                                value="<?php echo $record['s_no']; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><span class="notranslate">Family No</span></label>
                            <input type="number" class="form-control" id="family_no" name="family_no"
                                value="<?php echo $record['family_no']; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><span class="notranslate">Name</span><span
                                    style="color:red;">*</span></label>
                        ...
                        <div class="form-group">
                            <label for=""><span class="notranslate">Age</span><span
                                    style="color:red;">*</span></label>
                        ...
                        <div class="form-group">
                            <label for=""><span class="notranslate">Mobile No</span><span
                                    style="color:red;">*</span></label>
                            <input type="number" class="form-control" id="mobile_no" name="mobile_no"
                                value="<?php echo $record['mobile_no']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="annual_income" name="annual_income"
                                value="<?php echo $record['annual_income']; ?>">
                        </div>
                            ...
                            <div class="row"
                                ...
                                <div class="col-xs-5" style=" margin-left:45px; padding:0px;">
                                    ...
                                    <img src="<?php echo $image_path; ?>/Food_Needed_Image/<?php echo $record['image']; ?>"
                                        id='store_picture1' name='picture' style="width: 100px; height: 100px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="abandoned_by_husband_or_child"
                                    name="stage" value="Abandoned by husband or child" <?php if ($record['stage'] == 'Abandoned by husband or child') {
                                        echo 'checked';
                                    } ?>>
                                <label class="custom-control-label pt-1" for="abandoned_by_husband_or_child"><span
                                        class="notranslate">Abandoned by husband or child</span></label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="widow" name="stage"
                                    value="widow" <?php if ($record['stage'] == 'widow') {
                                        echo 'checked';
                                    } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="disabled_person_yes"
                                    name="disabled_person" value="Yes" <?php if ($record['disabled_person'] == 'Yes') {
                                        echo 'checked';
                                    } ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="disabled_person_no"
                                    name="disabled_person" value="No" <?php if ($record['disabled_person'] == 'No') {
                                        echo 'checked';
                                    } ?>>
                        ...
                        <div class="form-group">
                            <label for=""><span class="notranslate">Food does not need to be guided by
                                    labour</span></label>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="food_does_not_needed_yes"
                                    name="food_does_not_needed" value="Yes" <?php if ($record['food_does_not_needed'] == 'Yes') {
                                        echo 'checked';
                                    } ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="food_does_not_needed_no"
                                    name="food_does_not_needed" value="No" <?php if ($record['food_does_not_needed'] == 'No') {
                                        echo 'checked';
                                    } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="profession" id="profession" class="form-control"
                                value="<?php echo $record['profession']; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><span class="notranslate">The reason for choosing
                                    food</span></label>
                            <input type="text" name="reason_for_choosing_food" id="reason_for_choosing_food"
                                class="form-control" value="<?php echo $record['reason_for_choosing_food']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="thanavanthar_name" id="thanavanthar_name"
                                class="form-control" value="<?php echo $record['thanavanthar_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount_of_giving" id="amount_of_giving" class="form-control"
                                value="<?php echo $record['amount_of_giving']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="coordinator_phone"
                                name="coordinator_phone" maxlength="10" onkeypress="return IsNumeric(event);"
                                value="<?php echo $record['coordinator_phone']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="masjidh_imam_phone"
                                name="masjidh_imam_phone" maxlength="10" onkeypress="return IsNumeric(event);"
                                value="<?php echo $record['masjidh_imam_phone']; ?>">
                        </div>

                        <div class="form-group">
                            <label for=""><span class="notranslate">President Name</span></label>
                            <input type="text" name="muttavalli_signature" id="muttavalli_signature"
                                class="form-control" value="<?php echo $record['muttavalli_signature']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" maxlength="10"
                                onkeypress="return IsNumeric(event);" value="<?php echo $record['phone']; ?>">
                        </div>
...
<script>
    ...
    function remove_img_btn_click() {
        document.getElementById("store_picture1").src = '';
        document.getElementById("store_picture1").style.display = "none";
        ...
        navigator.permissions.query({ name: 'camera' })
            .then(permissionStatus => {
                if (permissionStatus.state === 'granted') {
                    // Camera permission already granted, proceed with capturing image
                    captureImage();
                    ...
                    navigator.permissions.request({ name: 'camera' })
                        .then(permissionRequestResult => {
                            if (permissionRequestResult.state === 'granted') {
                                ...
                                alert('Camera permission denied. Please grant camera permission to capture images.');
                            }
                        });
                } else {
                    // Permission denied by default or blocked
                    alert('Camera permission is denied or blocked. Please enable camera permission in your device settings.');
                }
            });
    }
}
...
// Click event handler for taking picture button
$('#but_takes').click(function() {
    checkAndRequestCameraPermission();
});

// Click event handler for selecting image from gallery button
$("#but_selects").click(function() {
    checkAndRequestCameraPermission(); // You can modify this based on gallery permissions if needed
});
    ...
    function food_details_entry(country_id, state_id, district_id, city_id, area_id, user_id, food_needed_id, unique_no,
        completed_status) {
        if (food_needed_id != '') {
            var action = 'Update';
        } else {
        ...
        var image = upload_image1;
        var old_image = "<?php echo $record['image']; ?>";
        ...
        if (organization_name == '') {
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    $('#page_replace_div').load(FILE_PATH + '/food_details_form/list.php?user_id=' +
    ...
    function food_needed_create_back(country_id, state_id, district_id, city_id, area_id, user_id, unique_no,
        ...
        var completed_status = '<?php echo $completed_status; ?>';
        $("#previous_id").val('food_details_form/list.php');
        $('#page_replace_div').load(FILE_PATH + '/food_details_form/list.php?user_id=' + user_id + '&country_id=' +
