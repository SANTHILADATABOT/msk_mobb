	...
	<div class="table-responsive">               
	  <table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100 new-table">
		...
		<tbody>						
            <?php 
            $roll_id=1;
			$food_needed = $pdo_conn->prepare("SELECT * FROM food_needed WHERE delete_status!='1' and user_id='$user_id'");
			$food_needed->execute(); 
...
function food_needed_create(country_id,state_id,district_id,city_id,area_id,user_id,unique_no,completed_status)
{
	...
	$('#page_replace_div').load(FILE_PATH + '/food_details_form/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
...
{
	$("#previous_id").val('food_details_form/create.php');
	$('#page_replace_div').load(FILE_PATH + '/food_details_form/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&food_needed_id='+food_needed_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
}
