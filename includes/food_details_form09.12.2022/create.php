...
<div class="container-fluid" style="padding:0px;">
  ...
  <div class="cover-field form-group">
        ...
        <div class="row" style="  margin-bottom: 10px;margin-top: 0px;background-color:#f9f9f9;padding: 10px 10px 10px 10px;border-bottom: 1px solid #e6e6e6;" id="pic_div">
         ...
         src="<?php echo $image_path?>/Food_Needed_Image/<?php echo $record['image']; ?>" 
       ...
       <!--  End  aleration-->
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <label for=""><span class="notranslate">Food does not need to be guided by labor</span></label>
                <div class="custom-control custom-radio custom-control-inline">
            ...
            <div class="form-group">
                <label for=""><span class="notranslate">Thanavanthar Name</span></label>
