...
<div class="container h-100 animated bounceInLeft"
	...
	<div class="row">
			...
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Job')">
						...
						<span class="notranslate icn-txt1">Job Opportunities</span>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Medical')">
						...
						<span class="notranslate icn-txt1">Medical Donors</span>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Shelter')">
						...
						<span class="notranslate icn-txt1">Shelter Donors</span>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Widow')">
						...
						<span class="notranslate icn-txt1">Widow Support Network</span>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Blood')">
						<img src="<?php echo $image_path;?>/vo.png" style="width:60px;height:60px">
		...
		<div class="col-6 mt-4">
			<div class="align-self-center mx-auto">
				<div class="voln_img1  btn btn-light btn-square-md rounded-lg">
					<button type="button" class="btn btn-volu" onClick="help_form('Food')">
						<img src="<?php echo $image_path;?>/food.png" style="width:60px;height:60px">
						<span class="notranslate icn-txt1">Food Donors</span>
					</button>
				</div>
			</div>
		</div>
