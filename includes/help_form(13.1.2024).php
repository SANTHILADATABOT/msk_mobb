        ...
        <div class="col-md-12 survey_content">
          <form class="login_form">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" value="" onkeypress="return IsChar(event);"> 
            </div>

            <div class="form-group">
                <label for=""><span class="notranslate">Enter Mobile Number</span></label>
                <i class="fa fa-mobile icons" aria-hidden="true"></i>
                <input type="text" class="form-control" id="mobile_number" name="mobile_number" value="" maxlength="10" onkeypress="return IsNumeric(event);">
              </div>
            ...
            <div class="form-group">
              ...
              <button type="button" name="submit" id="submit" class="btn btn-success" onclick="validate_help()">Submit</button>
