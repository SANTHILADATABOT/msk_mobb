...
<input type="hidden" name="user_id" id="user_id" value="<?php echo$survey1_records['job_image']; ?>">
  ...
  <i class="fa fa-arrow-circle-left arrow_back" onClick="job_create_back('<?php echo $country_id ?>','<?php echo $state_id ?>','<?php echo $district_id ?>','<?php echo $city_id ?>','<?php echo $area_id ?>','<?php echo $user_id ?>','<?php echo $unique_no ?>','<?php echo $completed_status ?>')"></i>    </div> 
  </div>   
    ...
    <div class="container">
          ...
          <form class="login_form">
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio"   id="experience_yes" name="experience"
                  value="yes" <?php if($survey1_records['experience']=="yes") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio" id="experience_no" name="experience"
                  value="no" <?php if($survey1_records['experience']=="no") : ?>
                  checked="checked" <?php endif; ?>>
           ...
           <label>If Yes? write down the details</label>
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio"  id="passport_yes" name="passport"
                  value="yes" <?php if($survey1_records['passport']=="yes") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio"  id="passport_no" name="passport"
                  value="no" <?php if($survey1_records['passport']=="no") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio"  id="marital_status_married" name="marital_status"
                  value="married" <?php if($survey1_records['marital_status']=="married") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="checkbox" class="serve" id="license_yes" name="license"
                  value="yes"<?php if (preg_match("/yes/", "$license1")) { echo "checked";} else {echo "";} ?> >
                <label class="custom-control-label pt-1" for="license_yes"> <span
                    class="notranslate">Yes</span>  </label>
              </div>

              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve" id="license_no" name="license"
                  value="no" <?php if (preg_match("/no/", "$license1")) { echo "checked";} else {echo "";} ?>>
               ...
               <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve" id="license_two_wheeler" name="license"
                  value="two_wheeler" <?php if (preg_match("/two_wheeler/", "$license1")) { echo "checked";} else {echo "";} ?>>
               ...
               <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve" id="license_four_wheeler" name="license"
                  value="four_wheeler" <?php if (preg_match("/four_wheeler/", "$license1")) { echo "checked";} else {echo "";} ?>>
             ...
             <div class="form-group">
                ...
                <label for=""><span class="notranslate">Expect Salary</span></label>
                 ...
                 <div class="form-group">
              <label> From </label> <input type="text" class="form-control" id="from_salary" name="from_salary"
                  value="<?php echo $survey1_records['from_salary']; ?> ">
                </div>
                 <div class="form-group">
            <label> To</label> <input type="text" class="form-control" id="to_salary" name="to_salary"
                  value="<?php echo $survey1_records['to_salary']; ?> ">
              </div>
            </div>
            ...
            <div class="form-row">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-2">
                <input type="radio"  id="physically_yes" name="physically"
                  value="yes" <?php if($survey1_records['physically']=="yes") : ?>
                  checked="checked" <?php endif; ?> onclick="check_physically(this.value);">
                <label class="custom-control-label pt-1" for="physically_yes"> <span
                    class="notranslate">Yes</span>  </label>
              </div>

              <div class="custom-control-inline custom-checkbox mb-2 ml-2">
                <input type="radio"  id="physically_no" name="physically"
                  value="no" <?php if($survey1_records['physically']=="no") : ?>
                  checked="checked" <?php endif; ?> onclick="check_physically(this.value);">
             ...
             <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="checkbox" class="serve1" id="job1_full_time" name="job1"
                  value="full_time" <?php if (preg_match("/full_time/", "$job3")) { echo "checked";} else {echo "";} ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve1" id="job1_part_time" name="job1"
                  value="part_time" <?php if (preg_match("/part_time/", "$job3")) { echo "checked";} else {echo "";} ?>>
                <label class="custom-control-label pt-1" for="job1_part_time"> <span class="notranslate">Parttime
                  </span> </label>
              </div>

               <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve1" id="job1_weekend" name="job1"
                  value="weekend"<?php if (preg_match("/weekend/", "$job3")) { echo "checked";} else {echo "";} ?>>
               ...
               <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve1" id="job1_free_lancher" name="job1"
                  value="free_lancher"<?php if (preg_match("/free_lancher/", "$job3")) { echo "checked";} else {echo "";} ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="checkbox" class="serve2" id="location_home_town" name="location"
                  value="home_town" <?php if (preg_match("/home_town/", "$location1")) { echo "checked";} else {echo "";} ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve2" id="location_out_of_town" name="location"
                  value="out_of_town" <?php if (preg_match("/out_of_town/", "$location1")) { echo "checked";} else {echo "";} ?>>
               ...
               <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox" class="serve2" id="location_abroad" name="location"
                  value="abroad" <?php if (preg_match("/abroad/", "$location1")) { echo "checked";} else {echo "";} ?>>
      ...
      <div class="cover-field">
        ...
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
         ...
         <img 
         <?php 
                if($survey1_records['job_image']!=null){?>
         
         src="<?php echo $image_path?>/job_image/<?php echo $survey1_records['job_image']; ?>" 
      ...
      <div class="row no-gutters justify-content-center">
        <div class="col-12">
           <a  onClick="get_job('<?php echo $country_id ?>','<?php echo $state_id ?>','<?php echo $district_id ?>','<?php echo $city_id ?>','<?php echo $area_id ?>','<?php  echo $unique_no?>','<?php echo $completed_status ?>')">
              <button type="button" class="btn btn-success next_btn" > <?php if($_GET['job_id']=='')  { ?> <span class="notranslate"> Save <?php } else {  ?> Update <?php  } ?></span><i
   ...
   var dob = $("#dob").val();
    ...
    $.ajax({
      ...
      {   
        ...
        $('#page_replace_div').load(FILE_PATH+"/job_application/job_list.php?user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
       }
});
}
   }  
