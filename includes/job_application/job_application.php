...
<div class="col-md-2 top_left">
    <i class="fa fa-arrow-circle-left arrow_back"
        onClick="job_create_back('<?php echo $country_id; ?>','<?php echo $state_id; ?>','<?php echo $district_id; ?>','<?php echo $city_id; ?>','<?php echo $area_id; ?>','<?php echo $user_id; ?>','<?php echo $unique_no; ?>','<?php echo $completed_status; ?>')"></i>
</div>
</div>
                ...
                <form class="login_form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_no" name="id_no"
                            value="<?php echo $survey1_records['id_no']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="radio" id="gender_female" name="gender" value="female" <?php if ($survey1_records['gender'] == "female") : ?>
                                checked="checked" <?php endif; ?>>
                            <label class="custom-control-label pt-1" for="gender_female"> <span
                                    class="notranslate">Female</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="radio" id="gender_male" name="gender" value="male" <?php if ($survey1_records['gender'] == "male") : ?>
                                checked="checked" <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <i class="icon-home icons"></i>
                        <input type="" class="form-control" id="qualification" name="qualification"
                            value="<?php echo $survey1_records['qualification']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="radio" id="experience_yes" name="experience" value="yes"
                                <?php if ($survey1_records['experience'] == "yes") : ?> checked="checked" <?php endif; ?>>
                            <label class="custom-control-label pt-1" for="experience_yes"> <span
                                    class="notranslate">yes</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="radio" id="experience_no" name="experience" value="no"
                                <?php if ($survey1_records['experience'] == "no") : ?> checked="checked" <?php endif; ?>>
                            <label class="custom-control-label pt-1" for="experience_no"> <span
                                    class="notranslate">No
                                </span> </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="exp_yes1" id="exp_yes1" class="form-control"
                            value="<?php echo $survey1_records['exp_yes1']; ?>">
                        <input type="text" name="exp_yes2" id="exp_yes2" class="form-control"
                            value="<?php echo $survey1_records['exp_yes2']; ?>">
                    </div>
                    <div class="form-group">
                        <label for=""><span class="notranslate">Language Known</span></label>
                        <input type="text" name="language" id="language" class="form-control"
                            value="<?php echo $survey1_records['language']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pincode" id="pincode" class="form-control"
                            value="<?php echo $survey1_records['pincode']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="radio" id="passport_yes" name="passport" value="yes"
                                <?php if ($survey1_records['passport'] == "yes") : ?> checked="checked" <?php endif; ?>>
                            <label class="custom-control-label pt-1" for="passport_yes"> <span
                                    class="notranslate">yes</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="radio" id="passport_no" name="passport" value="no"
                                <?php if ($survey1_records['passport'] == "no") : ?> checked="checked" <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="radio" id="marital_status_married" name="marital_status" value="married"
                                <?php if ($survey1_records['marital_status'] == "married") : ?> checked="checked" <?php endif; ?>>
                            <label class="custom-control-label pt-1" for="marital_status_married"> <span
                                    class="notranslate">Married</span> </label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="checkbox" class="serve" id="license_yes" name="license" value="yes"
                                <?php if (preg_match('/yes/', "$license1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="license_yes"> <span
                                    class="notranslate">Yes</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve" id="license_no" name="license" value="no"
                                <?php if (preg_match('/no/', "$license1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve" id="license_two_wheeler" name="license"
                                value="two_wheeler" <?php if (preg_match('/two_wheeler/', "$license1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="license_two_wheeler"> <span
                                    class="notranslate">Two_Wheeler
                                </span> </label>
                        </div>
                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve" id="license_four_wheeler" name="license"
                                value="four_wheeler" <?php if (preg_match('/four_wheeler/', "$license1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="license_four_wheeler"> <span
                                    class="notranslate">Four Wheeler
                                </span> </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="" class="two_hgt"><span class="notranslate">Area of
                                Interest</span></label>
                        <i class="icon-home icons"></i>
                        <input type="text" class="form-control" id="area_of_interest" name="area_of_interest"
                            value="<?php echo $survey1_records['area_of_interest']; ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label> From </label> <input type="text" class="form-control" id="from_salary"
                                name="from_salary" value="<?php echo $survey1_records['from_salary']; ?> ">
                        </div>
                        <div class="form-group">
                            <label> To</label> <input type="text" class="form-control" id="to_salary"
                                name="to_salary" value="<?php echo $survey1_records['to_salary']; ?> ">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <div>
                                <label for=""><span class="notranslate">Are you Physically
                                        Challenged</span></label>
                            </div>
                            <div class="custom-control-inline custom-checkbox mb-2 mx-2">
                                <input type="radio" id="physically_yes" name="physically" value="yes"
                                    <?php if ($survey1_records['physically'] == "yes") : ?> checked="checked" <?php endif; ?>
                                    onclick="check_physically(this.value);">
                                <label class="custom-control-label pt-1" for="physically_yes"> <span
                                        class="notranslate">Yes</span> </label>
                            </div>

                            <div class="custom-control-inline custom-checkbox mb-2 ml-2">
                                <input type="radio" id="physically_no" name="physically" value="no"
                                    <?php if ($survey1_records['physically'] == "no") : ?> checked="checked" <?php endif; ?>
                                    onclick="check_physically(this.value);">
                                <label class="custom-control-label pt-1" for="physically_no"> <span
                                        class="notranslate">No
                                    </span> </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group check_physically" style="display:None;">
                        <label for="" class="two_hgt"><span class="notranslate">Physically Challenged,
                                mentioned the disability</span></label>

                        <input type="text" class="form-control" id="disability" name="disability"
                            value="<?php echo $survey1_records['disability']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="checkbox" class="serve1" id="job1_full_time" name="job1"
                                value="full_time" <?php if (preg_match('/full_time/', "$job3")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="job1_full_time"> <span
                                    class="notranslate">Full Time</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve1" id="job1_part_time" name="job1"
                                value="part_time" <?php if (preg_match('/part_time/', "$job3")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="job1_part_time"> <span
                                    class="notranslate">Parttime
                                </span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve1" id="job1_weekend" name="job1" value="weekend"
                                <?php if (preg_match('/weekend/', "$job3")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="job1_weekend"> <span
                                    class="notranslate">Weekend
                                </span> </label>
                        </div>
                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve1" id="job1_free_lancher" name="job1"
                                value="free_lancher" <?php if (preg_match('/free_lancher/', "$job3")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="job1_free_lancher"> <span
                                    class="notranslate">Free Lancher
                                </span> </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                            <input type="checkbox" class="serve2" id="location_home_town" name="location"
                                value="home_town" <?php if (preg_match('/home_town/', "$location1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="location_home_town"> <span
                                    class="notranslate">Home Town</span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve2" id="location_out_of_town" name="location"
                                value="out_of_town" <?php if (preg_match('/out_of_town/', "$location1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="location_out_of_town"> <span
                                    class="notranslate">Out of Town
                                </span> </label>
                        </div>

                        <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                            <input type="checkbox" class="serve2" id="location_abroad" name="location"
                                value="abroad" <?php if (preg_match('/abroad/', "$location1")) {
                                    echo 'checked';
                                } else {
                                    echo '';
                                } ?>>
                            <label class="custom-control-label pt-1" for="location_abroad"> <span
                                    class="notranslate">Abroad
                                </span> </label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hobbies" name="hobbies"
                            value="<?php echo $survey1_records['hobbies']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="per_address" name="per_address"
                            value="<?php echo $survey1_records['per_address']; ?>">
                            ...
                            <div class="cover-field">
                                ...
                                <div class="row"
                                    ...
                                    <div class="col-xs-5" style=" margin-left:45px; padding:0px;">
                                        <?php if ($survey1_records['job_image'] != null) { ?>
                                            <img src="<?php echo $image_path; ?>/job_image/<?php echo $survey1_records['job_image']; ?>" id='store_picture'
                                            name='store_picture' style="width: 100px; height: 100px;">
                    ...
                    <div class="form-group">
                        <label for=""><span class="notranslate">Mobile</span></label>
                        <input type="text" name="muththavalli_signature_mobile" id="muththavalli_signature_mobile"
                            class="form-control" value="<?php echo $survey1_records['muththavalli_signature_mobile']; ?>">
                    </div>
    ...
    <div class="no-gutters">
        <div class="col-auto mx-auto">
            <div class="row no-gutters justify-content-center">
                <div class="col-12">
                    <a
                        onClick="get_job('<?php echo $country_id; ?>','<?php echo $state_id; ?>','<?php echo $district_id; ?>','<?php echo $city_id; ?>','<?php echo $area_id; ?>','<?php echo $unique_no; ?>','<?php echo $completed_status; ?>')">
                        <button type="button" class="btn btn-success next_btn"> <?php if ($_GET['job_id'] == '') { ?> <span
                                class="notranslate"> Save <?php } else {  ?> Update <?php  } ?></span><i
...
<script>
    ...
    function get_job(country_id, state_id, district_id, city_id, area_id, unique_no, completed_status)
    {
        ...
        var job_image = upload_image1;
        var old_image = "<?php echo $survey1_records['job_image']; ?>";
        ...
        if (id_no == '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#page_replace_div').load(FILE_PATH + "/job_application/job_list.php?user_id=" +
    ...
    function job_create_back(country_id, state_id, district_id, city_id, area_id, user_id, unique_no, completed_status) {
        ...
        $('#page_replace_div').load(FILE_PATH + '/job_application/job_list.php?user_id=' + user_id + '&country_id=' +
