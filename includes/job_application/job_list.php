...
<?php 
	$survey = $pdo_conn->prepare("SELECT * FROM job_application $query");
	$survey->execute();
...
function edit_job(job_id,user_id,country_id,state_id,district_id,city_id,area_id,unique_no,completed_status)
{
	...
	$("#page_replace_div").load(FILE_PATH+'/job_application/job_application.php?job_id='+job_id+"&user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status+'&user_type='+user_type);
	hide_dialog();
}
...
{	
	...
	{		
		...
		success:function(data)
		{
            ...
            var unique_no = '<?php echo $unique_no; ?>';
            var completed_status = '<?php echo $completed_status; ?>';
			$("#page_replace_div").load(FILE_PATH+'/job_application/job_list.php?job_id='+job_id+"&user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status+'&user_type='+user_type);
		}				
		});	
	}
}
