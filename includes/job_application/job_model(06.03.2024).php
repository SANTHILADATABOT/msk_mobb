...
if($_POST['action']=="add") 
{
  ...
  $statement = $pdo_conn->prepare("INSERT INTO  job_application (user_id, id_no, dob, contact_no ,age, gender, qualification, experience, exp_yes1, exp_yes2, language, city, pincode, passport, marital_status, license, area_of_interest, from_salary, to_salary, physically,disability,job,location,hobbies,name,father_name,mother_name,per_address,mobile_no,whatsapp_no,email,job_image,school_name , school_imam_signature , signature_name , signature_mobile,muththavalli_signature , muththavalli_signature_name , muththavalli_signature_mobile, country_id, state_id, district_id, city_id, area_id) 
          VALUES (:user_id, :id_no, :dob, :contact_no, :age, :gender, :qualification, :experience, :exp_yes1, :exp_yes2,:language, :city, :pincode, :passport, :marital_status, :license, :area_of_interest, :from_salary, :to_salary,:physically,:disability, :job,:location,:hobbies,:name,:father_name,:mother_name,:per_address,:mobile_no,:whatsapp_no,:email,:job_image, :school_name , :school_imam_signature , :signature_name ,:signature_mobile ,:muththavalli_signature , :muththavalli_signature_name , :muththavalli_signature_mobile,:country_id, :state_id, :district_id, :city_id, :area_id)");
...
if($_POST['job_image']!=null){
	$pdo_statement=$pdo_conn->prepare("update job_application set user_id='".$user_id."',id_no='".$_POST['id_no']."',dob='".$_POST['dob']."',contact_no='".$_POST['contact_no']."',age='".$_POST['age']."',gender='".$_POST['gender']."',qualification='".$_POST['qualification']."',experience='".$_POST['experience']."',exp_yes1='".$_POST['exp_yes1']."',exp_yes2='".$_POST['exp_yes2']."',language='".$_POST['language']."',city='".$_POST['city']."',pincode='".$_POST['pincode']."',passport='".$_POST['passport']."',marital_status='".$_POST['marital_status']."',license='".$_POST['insert']."',area_of_interest='".$_POST['area_of_interest']."',from_salary='".$_POST['from_salary']."',to_salary='".$_POST['to_salary']."',physically='".$_POST['physically']."',disability='".$_POST['disability']."',job='".$_POST['insert1']."',location='".$_POST['insert2']."',hobbies='".$_POST['hobbies']."',name='".$_POST['name']."' ,father_name='".$_POST['father_name']."',mother_name='".$_POST['mother_name']."',per_address='".$_POST['per_address']."',mobile_no='".$_POST['mobile_no']."',whatsapp_no='".$_POST['whatsapp_no']."',email='".$_POST['email']."',job_image='".$_POST['job_image']."',school_name='".$_POST['school_name']."',school_imam_signature='".$_POST['school_imam_signature']."',signature_name='".$_POST['signature_name']."',signature_mobile='".$_POST['signature_mobile']."',muththavalli_signature='".$_POST['muththavalli_signature']."',muththavalli_signature_name='".$_POST['muththavalli_signature_name']."',muththavalli_signature_mobile='".$_POST['muththavalli_signature_mobile']."',state_id='".$_POST['state_id']."',country_id='".$_POST['country_id']."',state_id='".$_POST['state_id']."',district_id='".$_POST['district_id']."',city_id='".$_POST['city_id']."',area_id='".$_POST['area_id']."' where job_id='".$_POST['job_id']."' ");
	   $result = $pdo_statement->execute();
}
else{
	$pdo_statement=$pdo_conn->prepare("update job_application set user_id='".$user_id."',id_no='".$_POST['id_no']."',dob='".$_POST['dob']."',contact_no='".$_POST['contact_no']."',age='".$_POST['age']."',gender='".$_POST['gender']."',qualification='".$_POST['qualification']."',experience='".$_POST['experience']."',exp_yes1='".$_POST['exp_yes1']."',exp_yes2='".$_POST['exp_yes2']."',language='".$_POST['language']."',city='".$_POST['city']."',pincode='".$_POST['pincode']."',passport='".$_POST['passport']."',marital_status='".$_POST['marital_status']."',license='".$_POST['insert']."',area_of_interest='".$_POST['area_of_interest']."',from_salary='".$_POST['from_salary']."',to_salary='".$_POST['to_salary']."',physically='".$_POST['physically']."',disability='".$_POST['disability']."',job='".$_POST['insert1']."',location='".$_POST['insert2']."',hobbies='".$_POST['hobbies']."',name='".$_POST['name']."' ,father_name='".$_POST['father_name']."',mother_name='".$_POST['mother_name']."',per_address='".$_POST['per_address']."',mobile_no='".$_POST['mobile_no']."',whatsapp_no='".$_POST['whatsapp_no']."',email='".$_POST['email']."',school_name='".$_POST['school_name']."',school_imam_signature='".$_POST['school_imam_signature']."',signature_name='".$_POST['signature_name']."',signature_mobile='".$_POST['signature_mobile']."',muththavalli_signature='".$_POST['muththavalli_signature']."',muththavalli_signature_name='".$_POST['muththavalli_signature_name']."',muththavalli_signature_mobile='".$_POST['muththavalli_signature_mobile']."',state_id='".$_POST['state_id']."',country_id='".$_POST['country_id']."',state_id='".$_POST['state_id']."',district_id='".$_POST['district_id']."',city_id='".$_POST['city_id']."',area_id='".$_POST['area_id']."' where job_id='".$_POST['job_id']."' ");
	   $result = $pdo_statement->execute();
