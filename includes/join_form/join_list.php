...
/*$("#page_replace_div").load(FILE_PATH+'/customer_creation/create.php?customer_id='+customer_id+"&user_type_id="+user_type_id+"&usercreation_id="+usercreation_id);
	...
	$("#page_replace_div").load(FILE_PATH+"/join_form/join_create.php?join_id="+join_id+"&user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
	hide_dialog();
}
...
{	
	...
	{		
		...
		{
			alert(data);
			$("#page_replace_div").load(FILE_PATH+'/join_form/join_list.php?join_id='+join_id+'&user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
		}				
		});	
	}
}
