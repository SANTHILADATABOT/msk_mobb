...
$statement = $pdo_conn->prepare("INSERT INTO  join_masjith (user_id, district_name, taluk, city, image, name, father_name, age, profession, pay_amount, address, mobile_no, email,serve_department, country_id, state_id, district_id, city_id, area_id) VALUES (:user_id, :district_name, :taluk, :city, :image, :name, :father_name, :age, :profession, :pay_amount, :address, :mobile_no, :email,:serve_department,:country_id, :state_id, :district_id, :city_id, :area_id)");
