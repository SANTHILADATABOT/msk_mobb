...
{		
 ...
 $sql = "SELECT count(*) FROM usercreation  where (username='".$username."' || mobile='".$username."') and password='".$password."' and active_status='1' and delete_status='0' "; 
...
if($number_of_rows==1)
{
	$login_main=$pdo_conn->prepare("SELECT * FROM usercreation where  (username='".$username."' || mobile='".$username."') and password='".$password."' and active_status='1' and delete_status='0' "); 
