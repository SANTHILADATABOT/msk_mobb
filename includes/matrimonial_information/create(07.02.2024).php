    ...
    <div class="container">
      <div class="row">
          ...
          <form class="login_form">
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio" id="gender_male" name="gender"
                  value="male" <?php if($survey1_records['gender']=="male") : ?>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio"  id="gender_female" name="gender"
                  value="female" <?php if($survey1_records['gender']=="female") : ?>
                  checked="checked" <?php endif; ?>>
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                ...
                <i class="icon-screen-smartphone icons"></i>
                <input type="text" class="form-control" id="tiniyat_scholarship" name="tiniyat_scholarship"
                  value="<?php echo $survey1_records['tiniyat_scholarship']; ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="education_qualification" name="education_qualification"
                  value="<?php echo $survey1_records['education_qualification']; ?>">
              </div>
             ...
             <div class="form-group">
                ...
                <i class="icon-screen-smartphone icons"></i>
                <input type="text" class="form-control" id="unmarried_brother" name="unmarried_brother"
                  value="<?php echo $survey1_records['unmarried_brother']; ?>">
              </div>
               <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio" id="worker_yes" name="worker"
                  value="yes" <?php if($survey1_records['worker']=="yes") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio"  id="worker_no" name="worker"
                  value="no" <?php if($survey1_records['worker']=="no") : ?>
                  checked="checked" <?php endif; ?>>
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio"  id="if_worker_business_business" name="if_worker"
                  value="business" <?php if($survey1_records['if_worker']=="business") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio" id="if_worker_employee_employee" name="if_worker"
                  value="employee" <?php if($survey1_records['if_worker']=="no") : ?>
                  checked="checked" <?php endif; ?>>
            ...
            <div class="form-group">
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="radio"  id="marital_status_unmarried" name="marital_status"
                  value="unmarried" <?php if($survey1_records['marital_status']=="unmarried") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio"  id="marital_status_widower_widow" name="marital_status"
                  value="widower_widow" <?php if($survey1_records['marital_status']=="widower_widow") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="radio"  id="marital_status_divorce" name="marital_status"
                  value="divorce" <?php if($survey1_records['marital_status']=="divorce") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="checkbox"  id="passed_away_none" name="passed_away"
                  value="none" <?php if($survey1_records['passed_away']=="none") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox"  id="passed_away_father" name="passed_away"
                  value="father" <?php if($survey1_records['passed_away']=="father") : ?>
                  checked="checked" <?php endif; ?>>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox"  id="passed_away_mother" name="passed_away"
                  value="mother" <?php if($survey1_records['passed_away']=="mother") : ?>
                  checked="checked" <?php endif; ?>>
                <label class="custom-control-label pt-1" for="passed_away_mother"> <span class="notranslate">Mother
                  </span> </label>
              </div>
          <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox"  id="passed_away_both" name="passed_away"
                  value="both" <?php if($survey1_records['passed_away']=="both") : ?>
                  checked="checked" <?php endif; ?>>
            ...
            <div class="form-group">
              ...
              <i class="icon-home icons"></i>
              <input type="" class="form-control" id="father_profession" name="father_profession"
                value="<?php echo $survey1_records['father_profession']; ?>">
            </div>
              ...
              <div class="custom-control-inline custom-checkbox mb-2 mx-4">
                <input type="checkbox"  id="handicapped_yes" name="handicapped"
                  value="yes" <?php if($survey1_records['handicapped']=="yes") : ?>
                  checked="checked" <?php endif; ?> onclick="check_handicapped(this.value);">
                <label class="custom-control-label pt-1" for="handicapped_yes"> <span
                    class="notranslate">Yes/ஆம்</span>  </label>
              </div>

              <div class="custom-control-inline custom-checkbox mb-2 ml-4">
                <input type="checkbox"  id="handicapped_no" name="handicapped"
                  value="no" <?php if($survey1_records['handicapped']=="no") : ?>
                  checked="checked" <?php endif; ?> onclick="check_handicapped(this.value);">
        ...
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
         ...
         <img 
         <?php 
                if($survey1_records['image1']!=null){?>
         
         src="<?php echo $image_path?>/matrimonial_information/<?php echo $survey1_records['image1']; ?>" 
 ...
 <div class="form-group">
      ...
      <div class="cover-field form-group">
        ...
        <div class="col-xs-5" style=" margin-left:45px; padding:0px;"> 
         <img 
         <?php 
                if($survey1_records['image2']!=null){?>
         src="<?php echo $image_path?>/matrimonial_information/<?php echo $survey1_records['image2']; ?>" 
         id='picture1' name='picture1' style="width: 100px; height: 100px;" >
          <?php }?>
      ...
      <div class="row no-gutters justify-content-center">
        <div class="col-12">
           <a  onClick="get_matrimonial('<?php echo $country_id ?>','<?php echo $state_id ?>','<?php echo $district_id ?>','<?php echo $city_id ?>','<?php echo $area_id ?>','<?php echo $unique_no ?>','<?php echo $completed_status ?>')">
              <button type="button" class="btn btn-success next_btn" > <?php if($_GET['matrimonial_id']=='')  { ?> <span class="notranslate"> Save <?php } else {  ?> Update <?php  } ?></span><i
...
if(id_number==''){
    ...
    $.ajax({
      ...
      {   
        ...
        $('#page_replace_div').load(FILE_PATH+'/matrimonial_information/matrimonial_list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
       }
});
}
   }  
...
function matrimonial_create_back(country_id,state_id,district_id,city_id,area_id,user_id,unique_no)
{
  ...
  $('#page_replace_div').load(FILE_PATH + '/matrimonial_information/matrimonial_list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no);
}
