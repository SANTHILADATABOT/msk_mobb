...
<?php 
	$survey = $pdo_conn->prepare("SELECT * FROM matrimonial_information where user_id='".$user_id."' ");
	$survey->execute();
...
function edit_matrimonial(matrimonial_id,user_id,country_id,state_id,district_id,city_id,area_id,unique_no,completed_status)
{
	...
	$("#page_replace_div").load(FILE_PATH+'/matrimonial_information/create.php?matrimonial_id='+matrimonial_id+"&user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
	hide_dialog();
}
...
{	
	...
	{		
		...
		{
			alert(data);
			$("#page_replace_div").load(FILE_PATH+'/matrimonial_information/matrimonial_list.php?matrimonial_id='+matrimonial_id+"&user_id="+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status);
		}				
		});	
	}
}
