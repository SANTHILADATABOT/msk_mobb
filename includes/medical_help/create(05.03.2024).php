    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
         ...
         src="<?php echo $image_path?>/medical_help/<?php echo $record['image1']; ?>" 
      ...
      <div class="cover-field form-group">
        ...
        <div class="row" style="  margin-bottom: 10px;margin-top: 0px;background-color:#f9f9f9;padding: 10px 10px 10px 10px;border-bottom: 1px solid #e6e6e6;" id="pic_div">
            ...
            <!--image_shown-->
         <div class="col-xs-5" style="padding:0px;">   <img src="<?php echo $image_path?>/common_images/images.jpg" id='picture2' name='picture2' style="width: 100px; height: 100px;" >
        </div>
        
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
          <div class="col-xs-6"> <img id='but_takes2' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/photo.png" style="width:45px;height:45px;"/> </div>
          <div class="col-xs-6"> <img id='but_selects2' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/gallery.png" style="width:45px;height:45px;"/> </div>
        </div>
        
         <div class="col-xs-5" style=" margin-left:45px; padding:0px;"> 
         <img 
         <?php 
                if($record['image2']!=null){?>
         
         src="<?php echo $image_path?>/medical_help/<?php echo $record['image2']; ?>" 
         id='picture2' name='picture2' style="width: 100px; height: 100px;" >
          <?php }?>
      ...
      <div class="cover-field form-group">
        ...
        <div class="row" style="  margin-bottom: 10px;margin-top: 0px;background-color:#f9f9f9;padding: 10px 10px 10px 10px;border-bottom: 1px solid #e6e6e6;" id="pic_div">
            ...
            <!--image_shown-->
         <div class="col-xs-5" style="padding:0px;">   <img src="<?php echo $image_path?>/common_images/images.jpg" id='picture3' name='picture3' style="width: 100px; height: 100px;" >
        </div>
        
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
          <div class="col-xs-6"> <img id='but_takes3' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/photo.png" style="width:45px;height:45px;"/> </div>
          <div class="col-xs-6"> <img id='but_selects3' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/gallery.png" style="width:45px;height:45px;"/> </div>
        </div>
        
         <div class="col-xs-5" style=" margin-left:45px; padding:0px;"> 
         <img 
         <?php 
                if($record['image3']!=null){?>
         
         src="<?php echo $image_path?>/medical_help/<?php echo $record['image3']; ?>" 
         id='picture3' name='picture3' style="width: 100px; height: 100px;" >
          <?php }?>
      ...
      <div class="cover-field form-group">
        ...
        <div class="row" style="  margin-bottom: 10px;margin-top: 0px;background-color:#f9f9f9;padding: 10px 10px 10px 10px;border-bottom: 1px solid #e6e6e6;" id="pic_div">
            ...
            <!--image_shown-->
         <div class="col-xs-5" style="padding:0px;">   <img src="<?php echo $image_path?>/common_images/images.jpg" id='picture4' name='picture4' style="width: 100px; height: 100px;" >
        </div>
        
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
          <div class="col-xs-6"> <img id='but_takes4' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/photo.png" style="width:45px;height:45px;"/> </div>
          <div class="col-xs-6"> <img id='but_selects4' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/gallery.png" style="width:45px;height:45px;"/> </div>
        </div>
        
         <div class="col-xs-5" style=" margin-left:45px; padding:0px;"> 
         <img 
         <?php 
                if($record['image4']!=null){?>
         
         src="<?php echo $image_path?>/medical_help/<?php echo $record['image4']; ?>" 
         id='picture4' name='picture4' style="width: 100px; height: 100px;" >
          <?php }?>
      ...
      <div class="cover-field form-group">
        ...
        <div class="row" style="  margin-bottom: 10px;margin-top: 0px;background-color:#f9f9f9;padding: 10px 10px 10px 10px;border-bottom: 1px solid #e6e6e6;" id="pic_div">
            ...
            <!--image_shown-->
         <div class="col-xs-5" style="padding:0px;">   <img src="<?php echo $image_path?>/common_images/images.jpg" id='picture5' name='picture5' style="width: 100px; height: 100px;" >
        </div>
        
        <div class="col-xs-7" style="padding:0px;margin-top:20px;">
          <div class="col-xs-6"> <img id='but_takes5' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/photo.png" style="width:45px;height:45px;"/> </div>
          <div class="col-xs-6"> <img id='but_selects5' enctype="multipart/form-data" src="<?php echo $image_path;?>/common_images/gallery.png" style="width:45px;height:45px;"/> </div>
        </div>
        
         <div class="col-xs-5" style=" margin-left:45px; padding:0px;"> 
         <img 
         <?php 
                if($record['image5']!=null){?>
         
         src="<?php echo $image_path?>/medical_help/<?php echo $record['image5']; ?>" 
         id='picture5' name='picture5' style="width: 100px; height: 100px;" >
          <?php }?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="signature_name" id="signature_name" class="form-control" value="<?php echo $record['signature_name'] ?>"> 
            </div>

            <div class="form-group">
                <label for=""><span class="notranslate">Mobile</span></label>
                <input type="number" name="signature_mobile" id="signature_mobile" class="form-control" maxlength="10" onkeypress="return IsNumeric(event);" value="<?php echo $record['signature_mobile'] ?>"> 
            </div>
            <div class="form-group">
                <label for=""><span class="notranslate">President signature</span></label>
                <input type="text" name="muththavalli_signature" id="muththavalli_signature" class="form-control" value="<?php echo $record['muththavalli_signature'] ?>" >  
            </div>

             <div class="form-group">
                <label for=""><span class="notranslate">Name</span></label>
                <input type="text" name="muththavalli_signature_name" id="muththavalli_signature_name" class="form-control" value="<?php echo $record['muththavalli_signature_name'] ?>"> 
            </div>

            <div class="form-group">
                <label for=""><span class="notranslate">Mobile</span></label>
                <input type="number" name="muththavalli_signature_mobile" id="muththavalli_signature_mobile" maxlength="10" onkeypress="return IsNumeric(event);" class="form-control" value="<?php echo $record['muththavalli_signature_mobile'] ?>"> 
            </div>
...
$('#but_takes2').click(function(){
  navigator.camera.getPicture(onSuccess2, onFail, { quality: 20,
    destinationType: Camera.DestinationType.FILE_URL 
  });
});
...
$("#but_selects2").click(function(){
  navigator.camera.getPicture(onSuccess2, onFail, { quality:50,
    sourceType: Camera.PictureSourceType.PHOTOLIBRARY, 
    allowEdit: false,
    destinationType: Camera.DestinationType.FILE_URI
  });
...
$('#but_takes3').click(function(){
  navigator.camera.getPicture(onSuccess3, onFail, { quality: 20,
    destinationType: Camera.DestinationType.FILE_URL 
  });
});
...
$("#but_selects3").click(function(){
  navigator.camera.getPicture(onSuccess3, onFail, { quality:50,
    sourceType: Camera.PictureSourceType.PHOTOLIBRARY, 
    allowEdit: false,
    destinationType: Camera.DestinationType.FILE_URI
  });
...
$('#but_takes4').click(function(){
  navigator.camera.getPicture(onSuccess4, onFail, { quality: 20,
    destinationType: Camera.DestinationType.FILE_URL 
  });
});
...
$("#but_selects4").click(function(){
  navigator.camera.getPicture(onSuccess4, onFail, { quality:50,
    sourceType: Camera.PictureSourceType.PHOTOLIBRARY, 
    allowEdit: false,
    destinationType: Camera.DestinationType.FILE_URI
  });
...
$('#but_takes5').click(function(){
  navigator.camera.getPicture(onSuccess5, onFail, { quality: 20,
    destinationType: Camera.DestinationType.FILE_URL 
  });
});
...
$("#but_selects5").click(function(){
  navigator.camera.getPicture(onSuccess5, onFail, { quality:50,
    sourceType: Camera.PictureSourceType.PHOTOLIBRARY, 
    allowEdit: false,
    destinationType: Camera.DestinationType.FILE_URI
  });
...
{    
  ...
  //ft.upload(imageURI,"<?php echo $image_path;?>/matrimonial_information/matrimonial_image.php", function(result)
   ...
   ft.upload(imageURI,"<?php echo $image_path;?>/medical_help/medical_image.php", function(result)
  {
...
{    
   ...
   ft.upload(imageURI,"<?php echo $image_path;?>/medical_help/medical_image.php", function(result)
  {
   // alert(result.response);
    var data=result.response;
    window.localStorage.setItem("image_name2",data.trim());
  }, 
  function(error)
  {
    alert('error : ' + JSON.stringify(error));
...
{    
   ...
   ft.upload(imageURI,"<?php echo $image_path;?>/medical_help/medical_image.php", function(result)
  {
   // alert(result.response);
    var data=result.response;
    window.localStorage.setItem("image_name3",data.trim());
  }, 
  function(error)
  {
    alert('error : ' + JSON.stringify(error));
...
{    
   ...
   ft.upload(imageURI,"<?php echo $image_path;?>/medical_help/medical_image.php", function(result)
  {
   // alert(result.response);
    var data=result.response;
    window.localStorage.setItem("image_name4",data.trim());
  }, 
  function(error)
  {
    alert('error : ' + JSON.stringify(error));
...
{    
   ...
   ft.upload(imageURI,"<?php echo $image_path;?>/medical_help/medical_image.php", function(result)
  {
   // alert(result.response);
    var data=result.response;
    window.localStorage.setItem("image_name5",data.trim());
  }, 
  function(error)
  {
    alert('error : ' + JSON.stringify(error));
...
{ 
  ...
  var image_name1=$("#image_name1").val();
    var medical_image1=window.localStorage.getItem("image_name1");
    var image_name2=$("#image_name2").val();
    var medical_image2=window.localStorage.getItem("image_name2");
    var image_name3=$("#image_name3").val();
    var medical_image3=window.localStorage.getItem("image_name3");
    var image_name4=$("#image_name4").val();
    var medical_image4=window.localStorage.getItem("image_name4");
    var image_name5=$("#image_name5").val();
    var medical_image5=window.localStorage.getItem("image_name5");
    ...
    $.ajax({
      ...
      {	  
        alert(msg)
          ...
          window.localStorage.removeItem("image_name2");
          window.localStorage.removeItem("image_name3");
          window.localStorage.removeItem("image_name4");
          window.localStorage.removeItem("image_name5");
        ...
        $('#page_replace_div').load(FILE_PATH + '/medical_help/list.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status+'&user_type='+user_type);
      } 
    });
  }
}
