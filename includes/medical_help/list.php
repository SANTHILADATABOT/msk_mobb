	...
	<div class="table-responsive">               
	  <table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100 new-table">
		...
		<tbody>						
            <?php 
            $roll_id=1;
			$medical_help = $pdo_conn->prepare("SELECT * FROM medical_help WHERE delete_status!='1' $query");
...
function medical_help_create(country_id,state_id,district_id,city_id,area_id,user_id,unique_no,completed_status)
{
	...
	$('#page_replace_div').load(FILE_PATH + '/medical_help/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&unique_no='+unique_no+'&completed_status='+completed_status+'&user_type='+user_type);
}
...
function medical_help_edit(medical_help_id,country_id,state_id,district_id,city_id,area_id,user_id,unique_no,completed_status)
{
        ...
        var completed_status = '<?php echo $completed_status; ?>';
	$("#previous_id").val('medical_help/create.php');
	$('#page_replace_div').load(FILE_PATH + '/medical_help/create.php?user_id='+user_id+'&country_id='+country_id+'&state_id='+state_id+'&district_id='+district_id+'&city_id='+city_id+'&area_id='+area_id+'&medical_help_id='+medical_help_id+'&unique_no='+unique_no+'&completed_status='+completed_status+'&user_type='+user_type);
}
