...
if($_POST['action']=='ADD')
{ 	 
	$pdo_statement = $pdo_conn->prepare("INSERT INTO medical_help (entry_date,patient_name, age, gender, disease_name, address, mobile_no, city, organization_name, coordinator_name, c_mobile_no, email,recommendation_form,medical_report , doctor_advice, surgery_amount, amount, medical_insurance_plan_card,bring_it,any_hospital_in_tamilnadu,medical_treatment_private,will_you_form,government_hospital, school_name, school_imam_signature, signature_name, signature_mobile, muththavalli_signature, muththavalli_signature_name, muththavalli_signature_mobile, country_id, state_id, district_id, city_id, area_id ,user_id) VALUES (:entry_date,:patient_name,:age, :gender, :disease_name,:address,:mobile_no,:city,:organization_name,:coordinator_name,:c_mobile_no,:email,:recommendation_form,:medical_report, :doctor_advice,:surgery_amount,:amount,:medical_insurance_plan_card,:bring_it,:any_hospital_in_tamilnadu,:medical_treatment_private,:will_you_form,:government_hospital,:school_name, :school_imam_signature, :signature_name, :signature_mobile, :muththavalli_signature, :muththavalli_signature_name, :muththavalli_signature_mobile, :country_id, :state_id, :district_id, :city_id, :area_id,:user_id)");
