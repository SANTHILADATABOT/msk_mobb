...
{ 
    $survy = $pdo_conn->prepare("SELECT * FROM  fact_finding_form  order by survey_id desc" );
    $survy->execute();
...
?>
          ...
          <form class="login_form">
            ...
            <div class="form-group">
              <label for=""><span class="notranslate">Family No </span>. / குடும்ப எண்    - <span style="color:red"><strong><?php echo $family_no[family_no]; ?>  </strong>    </span>       <!--<i class="fa fa-microphone create"  onclick="studentname_recognize()"></i><i class="fa fa-times create" aria-hidden="true" onclick="erase()"></i>-->
              </label>
              
              <input type='hidden' class="form-control" id='valfamily_no' name='valfamily_no'>

              <input type='number' class="form-control check_empt" id='family_no' onkeyup="family_number_checking(family_no);" name='family_no'  value='<?php if($_GET['unique_no']!=''){ echo $survey1_records['family_no'];  }  ?>'>
